USE [KlantenSimulatie]
GO
/****** Object:  Table [dbo].[Achternaam]    Script Date: 12/29/2025 7:25:10 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Gemeente]    Script Date: 12/29/2025 7:25:11 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Land]    Script Date: 12/29/2025 7:25:11 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Straat]    Script Date: 12/29/2025 7:25:11 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Versie]    Script Date: 12/29/2025 7:25:11 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Voornaam]    Script Date: 12/29/2025 7:25:11 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [dbo].[Achternaam]  WITH CHECK ADD  CONSTRAINT [FK_Achternaam_Versie] FOREIGN KEY([versieid])
...
GO
ALTER TABLE [dbo].[Voornaam]  WITH CHECK ADD  CONSTRAINT [FK_Voornaam_Versie] FOREIGN KEY([versieid])
REFERENCES [dbo].[Versie] ([id])
GO
